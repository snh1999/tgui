...
**User Story**: TGUI-01  
**Description**: User can save a command with name, executable, arguments, working directory, category, and environment variables.
...
**Description**: User can click "Run" to execute command with correct working directory, arguments, and environment variables.
...
- Deleting category moves commands to "Uncategorized"
